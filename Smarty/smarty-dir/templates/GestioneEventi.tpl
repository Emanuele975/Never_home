...
<div class="py-5 text-left" >
  <div class="container">
    <div class="row ml-5">
      <strong> Cerca evento  :</strong>
      <form class="form-inline my-2 my-lg-0 ml-3" method="post" enctype="multipart/form-data" action="/Never_home/Amministratore/CercadaNomeGratis">
          ...
          <ul class="media-list">
            {section name=evento loop=$eventi}
              <li class="media py-2">
                ...
                <form method="post" enctype="multipart/form-data" action="/Never_home/Amministratore/EliminaEvento/{$eventi[evento]->getId()}">
